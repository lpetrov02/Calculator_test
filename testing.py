...
class TestCalculator(unittest.TestCase):
    ...
    def test_pow_rational(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.power(3.14).value)),
    ...
    def test_root(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.root(25).value)),
    ...
    def test_root_less_zero(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.root(-10).value)),
                         float('{:.10f}'.format(1.0 / calc_value ** 0.1)))

    def test_root_rational(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.root(2.7).value)),
                         float('{:.10f}'.format(calc_value ** (1.0 / 2.7))))

    def test_root_large(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.root(1000).value)),
                         float('{:.10f}'.format(calc_value ** 0.001)))

    def test_multy_test1(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.add(30, 239).divide(20, 30, integer_divide=False).
                         power(7, 8, 350).subtract(1000000).value)),
                         float('{:.10f}'.format(((((calc_value + 269) / 600.0) ** 7) ** 8) - 1000000)))

    def test_multy_test2(self):
        self.calculator = Calculator()
        calc_value = self.calculator.value
        self.assertEqual(float('{:.10f}'.format(self.calculator.root(3, 5).multiply(10, 20, 30).
                                                subtract(10, 100, 1000000).power(4).value)),
                         float('{:.10f}'.format(((((calc_value ** (1.0 / 3.0)) ** (1.0 / 5.0)) * 6000.0) - 1000110) ** 4)))
